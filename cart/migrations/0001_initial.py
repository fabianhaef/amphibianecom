    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licence_variation', models.ManyToManyField(to='cart.LicenceVariations')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('licence_variation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.LicenceVariations')),
